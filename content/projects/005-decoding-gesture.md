...
::: images
decoding-gesture.jpg | es: La proyección de cerca: el anillo con las ocho bocinas numeradas, la cinta de ganancia, el cuerpo dentro y las trazas de las dos manos a los lados. Las dos dicen AGARRADA. CMMAS, Morelia, 2026. | en: The projection up close: the ring with its eight numbered speakers, the gain ribbon, the body inside, and the traces of both hands at either side. Both read AGARRADA, gripped. CMMAS, Morelia, 2026.
