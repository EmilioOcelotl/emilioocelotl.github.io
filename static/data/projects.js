export const projects = [
  ...
  },
  {
    ...
    "details": {
      "fullDescription": "<p>Estudios audiovisuales para el navegador. Este proyecto fue realizado en colaboración con Iracema de Andrade.</p><p>El repositorio con las primeras versiones se encuentra en: <a href= 'https://github.com/EmilioOcelotl/THREE.studies'>THREE.studies</a>.</p><p>La última versión se encuentra respaldada en: <a href='https://github.com/EmilioOcelotl/THREE.studies-II'>THREE.studies-II</a>. Para esta versión, despliego la instancia de un <a href='https://github.com/EmilioOcelotl/osc-web-server'>servidor osc web personalizado</a> y la biblioteca <a href='https://github.com/EmilioOcelotl/treslib'>treslib</a>, ambas escritas por mí. También implementa una <a href='https://github.com/EmilioOcelotl/MMLL'>variación</a> de la biblioteca MMLL.js trabajada en conjunto con Marianne Teixido, <a href='https://github.com/sicklincoln/MMLL'>proyecto original</a> de Nick Collins.</p>",
      "images": [
        "./img/iracema-r.jpg",
        "./img/threeclnF-r.png",
        "./img/three2024.jpg",
  ...
  },
  {
    ...
    "details": {
      "fullDescription": "<p>Presentación A/V en New Interfaces for Musical Expresion 2023.</p><p>La presentación se realizó en la explanada del Centro de Cultura Digital y se presentó en un programa con varias propuestas musicales y audiovisuales-</p><p>La organización de NIME decidió otorgarnos el premio a mejor música. El link con la decisión se puede encontrar en: <a href='https://www.nime2023.org/awards-photos'>https://www.nime2023.org/awards-photos</a>.</p>",
      "images": [
        "./img/nime1-r.jpg",
        "./img/nime3-r.jpg",
        "./img/nime-r.jpg"
  ...
  },
  {
    ...
    "details": {
      "fullDescription": "Presentación A/V con Dorian Sotomayor en Algorave CDMX 2023.",
      "images": [
        "./img/algorave2-r.jpg"
      ],
  ...
  },
  {
    ...
    "details": {
      "fullDescription": "RGGTRN full band en colaboración con Gabriel de Dios 'El Hijo de Tere' en Centro Cultural España de México (CDMX). ",
      "images": [
        "./img/xicalco-r.jpeg",
        "./img/2-r.jpeg",
        "./img/3-r.jpeg",
  ...
  },
  {
    ...
    "year": "2020",
    "description": "Espacios virtuales compartidos"
  },
  {
    "href": "feedback.html",
  ...
  },
  {
    ...
    "year": "2019",
    "description": "Presentación de RGGTRN en Linux Audio Conference"
  },
  {
  ...
  },
  {
    ...
    "year": "2017",
    "description": "RGGTRN - Bellacode Tour"
  }
];
