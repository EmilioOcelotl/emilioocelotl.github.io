export const projects_en = [

    {
        ...
        "details": {
          "fullDescription": "<p>RisOSC: writings on the multiplied scarce and the uniquely ephemeral.</p><p>The project combines risograph prints with NFC tags and 3D sculptures, structured in five parts:</p><ul><li>Web: pages that open on mobile or desktop devices when an NFC tag is read.</li><li>Server: manages readings and sends messages via sockets to the main page and specific pages.</li><li>Firmware: custom device that reads NFC tags without requiring a phone.</li><li>Export: renders can be exported as OBJ files for use in other contexts.</li><li>Scripts: the main page can run automatically on a computer for exhibition purposes.</li></ul><p>The project repository is available at: <a href='https://github.com/EmilioOcelotl/risosc'>RisOSC</a></p><p>Presented as part of the Algorítmica Íntima exhibition at the Centro de Cultura Digital, Mexico City, 2025.</p>",
          "images": [
            "./img/risosc16nov.jpg",
            "./img/risoscccd.jpeg",
            "./img/risosc4.jpg",
      ...
      },
      {
        ...
        "details": {
          "fullDescription": "<p>Obfuscation as a motif, writing as a detour.</p><p>Anti is a call for responsibility over data, commitment, and care, and for the participation of users who blur the boundaries of political and economic passivity, centering on the sensitive.</p><p>Online project: <a href='https://anti.ocelotl.cc/'>https://anti.ocelotl.cc/</a></p><p>Project code: <a href='https://github.com/EmilioOcelotl/anti'>https://github.com/EmilioOcelotl/anti</a></p><p>Supported by the National Fund for Culture and the Arts (FONCA).</p>",
          "images": [
            "./img/anti2-r.jpg",
            "./img/anti-r.jpg",
      ...
      },
      {
        ...
        "details": {
          "fullDescription": "<p>Audio-visual intervention based on astronomical data. This project was carried out in collaboration with ACT UNAM and the Institute of Astronomical Research. In this instance, we sonified and visualized data from astronomical jets.</p><p>Repository: <a href='https://github.com/EmilioOcelotl/nocheDeLasEstrellas2019'>nocheDeLasEstrellas2019</a></p>",
          "images": [
            "./img/disco3.jpg", 
            "./img/noche2019-1.jpg", 
            "./img/noche01-r.png", 
