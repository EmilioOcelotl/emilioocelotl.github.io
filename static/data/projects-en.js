export const projects_en = [
...

    {
      ...
      },
      {
        ...
        "details": {
          "fullDescription": "<p>MiniMapper is a real-time generative videomapping tool. Each surface is a deformable Bezier patch that takes as texture the output of Hydra, a video, an image, or the camera. Moving the control points slowly curves the edges; corner vertices anchor the surface in space.</p><p>Site: <a href='https://emilioocelotl.github.io/minimapper/'>emilioocelotl.github.io/minimapper</a></p><p>Repository: <a href='https://github.com/EmilioOcelotl/minimapper'>github.com/EmilioOcelotl/minimapper</a></p>",
          "images": [
